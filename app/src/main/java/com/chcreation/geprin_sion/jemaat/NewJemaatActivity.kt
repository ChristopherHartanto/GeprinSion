...
class NewJemaatActivity : AppCompatActivity(), MainView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = JemaatPresenter(this,mAuth,mDatabase, this)
    ...
    private fun saveJemaat(image: String?){
        ...
        presenter.createJemaat(Jemaat(nama,alamat,jenisKelamin,golDarah,tempatLahir,tanggalLahir,noTel,note,
            baptis,noSertifikat,tempatBaptis,tanggalBaptis,
            dateFormat().format(Date()),
            dateFormat().format(Date()),
            mAuth.currentUser!!.uid,
            mAuth.currentUser!!.uid,image,""))
    }
